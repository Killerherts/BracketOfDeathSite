#!/usr/bin/env python3
"""
Bracket of Death Data Fixer - Windows Compatible Version
=========================================================
...
Usage: python fix_bod_data_win.py
"""
...
class BODDataFixer:
    ...
    def fix_all_tournaments(self):
        ...
        print("=== BRACKET OF DEATH DATA FIXER ===")
        ...
        if total_errors == 0:
            ...
            print(f"\n{total_errors} errors remain. Check the output above for details.")
...
def main():
    ...
    if not os.path.exists(json_dir):
        ...
        print("Usage: python fix_bod_data_win.py [json_directory]")
        sys.exit(1)
